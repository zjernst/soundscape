...
Track.create({title: 'Gentle Rain Storm in Meadow', track_url: 'https://res.cloudinary.com/soundscape/video/upload/v1467350593/156994__chrscrwfrd18__rain_xat7od.mp3',
  description: "10 minutes of a gentle rain accompanied by field birds. Distant thunder claps interspersed.", soundscape_id: 1, artist_id: 2})
...
Track.create({title: 'Calmwaves / Sandbeack', track_url: 'https://res.cloudinary.com/soundscape/video/upload/v1467350407/191296__klankbeeld__calmwaves-sandbeach-03-eq-130430-03_ie21qa.mp3',
